...
public class ResponseBuilderObject implements PostSubscriber<ResponseEntity> {
    ...
    private Map<String, List<String>> transformValidationErrorsToJson(List<ValidationError> errors) {
